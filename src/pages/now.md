...
- [expo/expo#44563](https://github.com/expo/expo/pull/44563): `expo-router` infinite render loop fix across all 5 Stack composition components.
...
Expo SDK 56 canary apps on Convex, Better Auth, and RevenueCat. Two public: [Counter](/apps/counter) and [DreamSeeker](/apps/dreamseeker). Four private.
...
- [tanstack-cn](/projects/tanstack-cn) + [create-tanstack-cn](https://www.npmjs.com/package/create-tanstack-cn): CLI scaffolder and shared runtime package, same shape as shadcn's (`bun create tanstack-cn my-app`). 657 total downloads. TanStack Start + Vite 8 + Base UI + shadcn + oxlint/oxfmt. The [shadcn dark mode PR](https://github.com/shadcn-ui/ui/pull/10396) that merged last week is wired in.
