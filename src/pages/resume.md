...
title: "Resume"
description: "Ray, product engineer in NYC, freelance since 2013. 49 merged PRs upstream, 10 npm packages, React Native on Expo with Convex and Better Auth."
---
...
Product engineer in New York. Freelancing solo since 2013. Give me a real bug with the time to dig and I'll ship the fix. 49 PRs merged upstream to Expo, Convex, Bun, shadcn/ui, and others, every one came from hitting a wall in my own apps and chasing it down.
...
- Maintain [ramonclaudio/patches](https://github.com/ramonclaudio/patches) (58 patches for Bun, npm, pnpm, and Yarn) so my apps and other users ship the fix while upstream PRs are in review.
