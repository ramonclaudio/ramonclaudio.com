...
export const GET: APIRoute = async ({ site }) => {
  ...
  const pages = [
    ...
    [
      "Contributions",
      "contributions",
      "45 PRs merged across 11 upstream repos (Expo, Convex, Bun, shadcn/ui, Better Auth, Hermes, napi-rs, fumadocs, Astro, TanStack, App-Store-Connect-CLI), plus a public patches repo with 54 drop-in fixes for Bun, npm, pnpm, and Yarn.",
    ],
...
> Ray is a freelance product engineer in NYC, building since 2013. He ships React Native apps on Expo with Convex for backend and Better Auth for auth, and contributes fixes upstream: 45 merged PRs across 11 open-source repos and a public patches repo with 54 drop-in fixes. When he hits a dependency bug he traces the root cause, files the upstream PR, and ships a patch so his projects (and anyone else) aren't blocked on the merge.
