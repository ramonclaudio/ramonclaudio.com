...
When I hit a bug in a dep, I don't just fix it locally. I file the issue, open the upstream PR, and drop a patch in [ramonclaudio/patches](https://github.com/ramonclaudio/patches) so my projects (and anyone else hitting the same bug) can ship without waiting for the merge. 109 patch files across Bun, npm, pnpm, and Yarn. When the release lands, I bump the dep and delete the patch. 28 PRs merged across 10 repos so far, 8 of those to [@expo/ui](https://github.com/expo/expo/pulls?q=is:pr+author:ramonclaudio) (with 2 more open) building out the SwiftUI modifier layer. Every merged PR shipped as a patch first. Small habit. Adds up.
