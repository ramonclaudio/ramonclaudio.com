...
export const personEntity: SchemaNode = {
  ...
  description:
    "Product engineer. Writing code since 2013. Ships React Native apps on Expo with Convex for backend and Better Auth for auth. 47 merged PRs upstream to Expo, Convex, Bun, shadcn/ui, Better Auth, Hermes, napi-rs, fumadocs, Astro, TanStack, and App Store Connect CLI.",
  knowsAbout: [
    "TypeScript",
    "Swift",
    "Rust",
