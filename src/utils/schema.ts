...
export const personEntity: SchemaNode = {
  ...
  description:
    "Product engineer. Writing code since 2013. Ships React Native apps on Expo with Convex for backend and Better Auth for auth. 37 merged PRs upstream to Expo, Convex, Bun, shadcn/ui, Better Auth, napi-rs, fumadocs, Astro, and TanStack.",
  knowsAbout: [
    "TypeScript",
    "Swift",
    "Rust",
