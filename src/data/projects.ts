...
getToken();              // Show token instructions`,
  },
  {
    ...
    description:
      "A lightweight browser extension that enhances Tempo workflows by creating distraction-free windows for chat and canvas panels. Perfect for use alongside code editors.",
...
# 3. Select "Open Chat Panel" or "Open Canvas Panel"`,
  },
  {
    ...
    license: "MIT",
    features: [
      { title: "Profile Analytics", description: "Comprehensive user profile information" },
...
Vision().run(prompt="Describe", image_url="https://...")`,
  ...
  },
  {
    ...
    features: [
      ...
      { title: "Codebase Analysis", description: "Streamlines code review" },
    ],
