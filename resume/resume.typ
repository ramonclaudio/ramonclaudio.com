...
- 56 PRs merged upstream across 12 repos: #link("https://github.com/expo/expo/pulls?q=is%3Apr+author%3Aramonclaudio+is%3Amerged")[expo/expo] (33), #link("https://github.com/shadcn-ui/ui/pulls?q=is%3Apr+author%3Aramonclaudio+is%3Amerged")[shadcn-ui/ui] (5), #link("https://github.com/get-convex/better-auth/pulls?q=is%3Apr+author%3Aramonclaudio+is%3Amerged")[get-convex/better-auth] (5), #link("https://github.com/better-auth/better-auth/pulls?q=is%3Apr+author%3Aramonclaudio+is%3Amerged")[better-auth] (3), #link("https://github.com/fuma-nama/fumadocs/pulls?q=is%3Apr+author%3Aramonclaudio+is%3Amerged")[fumadocs] (2), #link("https://github.com/withastro/compiler-rs/pulls?q=is%3Apr+author%3Aramonclaudio+is%3Amerged")[withastro/compiler-rs] (2), plus #link("https://github.com/react/react-native/pull/57518")[react-native], #link("https://github.com/facebook/hermes/pull/2047")[hermes], #link("https://github.com/oven-sh/bun/pull/21855")[bun], #link("https://github.com/TanStack/db/pull/17")[TanStack/db], #link("https://github.com/napi-rs/napi-rs/pull/3189")[napi-rs], and App-Store-Connect-CLI. 10 more open across 6 repos including 2 source fixes to facebook/hermes (object-accessor home object, class-in-finally var caching), 2 in oven-sh/bun (CI YAML fix, peer-dep lockfile determinism), and the hermes-engine podspec in react/react-native.
...
- Maintain #link("https://github.com/ramonclaudio/patches")[ramonclaudio/patches] (68 patches for Bun, npm, pnpm, and Yarn) so my apps and other users ship the fix while upstream PRs are in review.
