...
#grid(
  ...
  [
    ...
    #v(-0.3em)
    #text(size: 10.5pt, fill: rgb("#555"))[Developer Tools Engineer · Brooklyn, NY]
  ],
...
- Build and maintain #link("https://www.npmjs.com/package/create-tanstack-cn")[tanstack-cn] (CLI scaffolder, \~1,300 downloads), #link("https://www.npmjs.com/package/create-claude")[create-claude] (1,870+ downloads), #link("https://www.convex.dev/components/ramonclaudio-convex-revenuecat")[convex-revenuecat] (21,500+ npm downloads, listed on the Convex Components Directory), and 8 other shipped npm packages, 34,000+ downloads across all of them.
