...
- Maintain #link("https://github.com/ramonclaudio/patches")[ramonclaudio/patches] (58 patches for Bun, npm, pnpm, and Yarn) so my apps and other users ship the fix while upstream PRs are in review.
